  ...
  return (
    <div className="w-full text-left font-sans text-[#0B1220] dark:text-[#F8FAFC]">
      <div className="w-full overflow-hidden">
        ...
        {/* =========================================================================
            1. DOWNLOAD HERO SECTION (Matching Contril Website Design System)
            ========================================================================= */}
        <section className="pt-8 pb-10 sm:pt-16 sm:pb-16 px-5 sm:px-8 max-w-5xl mx-auto text-center space-y-5 sm:space-y-6">
          ...
          {/* Technical Metadata */}
          <div className="pt-1 font-mono text-xs text-[#52627A] dark:text-[#94A3B8]">
        ...
        {/* =========================================================================
            ...
            ========================================================================= */}
        <section className="px-5 sm:px-8 lg:px-12 max-w-5xl mx-auto pb-20 sm:pb-24">
          ...
          <div className="text-center space-y-2 mb-10 sm:mb-12">
            ...
            <p className="text-sm sm:text-base text-[#52627A] dark:text-[#94A3B8] max-w-md mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8">
            ...
            <div className="rounded-2xl bg-white/85 dark:bg-[#0D121D]/90 backdrop-blur-2xl border border-white/60 dark:border-white/10 shadow-[0_30px_80px_rgba(37,99,235,0.12),0_10px_30px_rgba(15,23,42,0.06)] dark:shadow-[0_30px_80px_rgba(0,0,0,0.7)] p-6 sm:p-8 flex flex-col justify-between space-y-8 transition-all hover:border-[#BFDBFE] dark:hover:border-blue-500/40">
              <div className="space-y-5">
                ...
                <ul className="space-y-3 pt-2 text-left text-xs sm:text-sm text-[#334155] dark:text-[#CBD5E1]">
